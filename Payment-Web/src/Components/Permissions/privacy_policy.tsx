    ...
    <>
      <section className="terms-section">
        <div className="terms-layout">
          ...
          <p>
            This privacy policy sets out how MAANG TECHNOLOGIES PRIVATE LIMITED
            uses and protects any information that you give MAANG TECHNOLOGIES
            PRIVATE LIMITED when you visit their website and/or agree to
            purchase from them.
          </p>

          <p>
            MAANG TECHNOLOGIES PRIVATE LIMITED is committed to ensuring that
          ...
          <p>
            MAANG TECHNOLOGIES PRIVATE LIMITED may change this policy from time
          ...
          <h5>We are committed to ensuring that your information is secure.</h5>
          <p>
          ...
          <p>
            ...
            incorrect or incomplete, please write to FLAT NO.3327, TOWER NO.3,
            SERI LINGAMPALLY, GACHIBOWLI, K. V. RANGAREDDY HYDERABAD TELANGANA
            500032 . or contact us at or as soon as possible. We will promptly
